...
#ifndef ns_tcp_gusteau_h
#define ns_tcp_gusteau_h
...
public:
	TcpRttTimer(GusteauTcpAgent *rat): srtt_( 0.0 ), rtt_var_( 0.0 ), rto_( 1.0 ), first_measurement_done_( false ), rat_( rat ) {}
	...
	const double G = 0.1;
	const double K = 4.0;
	GusteauTcpAgent* rat_;

};

/* Gusteau TCP with Tahoe */
class GusteauTcpAgent : public virtual TcpAgent {
private:
	Memory _memory;
